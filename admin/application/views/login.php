...
::-moz-input-placeholder{
  ...
  <body>
    ...
    <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div><?php echo $this->template->white;?><span><?php echo $this->template->blue;?></span></div>
		</div>
		<br>
		<div class="login">
		<?php 
		...
		$username= form_input(array('name'=>'username','placeholder'=>'username'));
		$password= form_password(array('name'=>'password','placeholder'=>'password'));
		$checkbox=form_checkbox('remember','1');
		$submit=form_submit('slogin','Login');
		?>
		
				<?php echo $username; ?><br>
				<?php echo $password; ?><br>
				<?php echo $checkbox; ?>Remember me<br>
				<?php echo $submit; ?>
